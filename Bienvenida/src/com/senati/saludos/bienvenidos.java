...
/**
 * Servlet implementation class bienvenidos
 */
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PrintWriter out = new PrintWriter(response.getOutputStream());
			...
			out.println("<div class=\"container-fluid\">\r\n" + 
					"		<div class=\"row\">\r\n" + 
					"			<div class=\"col-md-12\" style=\"background-color: rgba(255, 192, 203,0.3);\">");
			out.println("<h1><center>Hola mundo desde el Servidor web </center></h1><br>");
			out.println("<a href='index.html'><input type ='submit' value='volver'/></a>");
			out.println("<p>Click en el boton retroceder");
			out.println("</p>");
